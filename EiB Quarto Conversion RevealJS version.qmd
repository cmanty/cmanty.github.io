...
::: main_stat
`r format(topline_BLS$unemp_rate[topline_BLS$date == max(topline_BLS$date)], scientific = FALSE, big.mark = ",")`%

[`r format(topline_BLS$date[topline_BLS$date == max(topline_BLS$date)], "%b. %Y")`]{.date_insert}

[`r format(topline_BLS$unemp_rate[topline_BLS$date == max(topline_BLS$date)] - topline_BLS$unemp_rate[topline_BLS$date == max(topline_BLS$date) %m-% years(1)], scientific = FALSE, big.mark = ",")`]{.main_stat2}
:::
...
::: main_stat
`r format(((topline_BLS$emp_count[topline_BLS$date == max(topline_BLS$date)] - topline_BLS$emp_count[topline_BLS$date == max(topline_BLS$date) %m-% years(1)])/topline_BLS$emp_count[topline_BLS$date == max(topline_BLS$date) %m-% years(1)])*100, scientifc = FALSE, big.mark = ",", digits = 3)`%

[`r format(topline_BLS$date[topline_BLS$date == max(topline_BLS$date)], "%b. %Y")`]{.date_insert}

[`r format(topline_BLS$emp_count[topline_BLS$date == max(topline_BLS$date)] - topline_BLS$emp_count[topline_BLS$date == max(topline_BLS$date) %m-% years(1)], scientific = FALSE, big.mark = ",", digits = 3)`]{.main_stat2}
:::
